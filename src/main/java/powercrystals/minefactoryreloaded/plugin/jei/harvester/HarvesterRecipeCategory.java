...
public class HarvesterRecipeCategory extends MachineRecipeCategory<HarvesterRecipeWrapper> {
    ...
    private final IDrawable plantWidget;
    ...
    private static final int PLANT_WIDGET_X = 40, PLANT_WIDGET_Y = 31;
    ...
    public HarvesterRecipeCategory(IGuiHelper guiHelper) {
        ...
        plantWidget = guiHelper.createDrawable(
                widgetsTexture,
                0, 64,
                16, 16
        );
    ...
    public void drawExtras(@Nonnull Minecraft minecraft) {
        plantWidget.draw(minecraft, PLANT_WIDGET_X, PLANT_WIDGET_Y);
    ...
    public List<String> getTooltipStrings(int mouseX, int mouseY) {
        ...
        if(mouseX >= PLANT_WIDGET_X && mouseX < PLANT_WIDGET_X + plantWidget.getWidth() && mouseY >= PLANT_WIDGET_Y && mouseY < PLANT_WIDGET_Y + plantWidget.getHeight()) {
            return Arrays.asList(
                    I18n.format("jei.info.mfr.harvester"),
                    I18n.format("jei.info.mfr.harvester.1")
            );
        }
