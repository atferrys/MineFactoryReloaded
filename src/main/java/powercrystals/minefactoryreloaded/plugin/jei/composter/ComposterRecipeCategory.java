...
public class ComposterRecipeCategory extends MachineRecipeCategory<ComposterRecipeWrapper> {
    ...
    private final int sewagePerOperation;
    ...
    @Override
    public void setRecipe(IRecipeLayout recipeLayout, @Nonnull ComposterRecipeWrapper recipeWrapper, IIngredients ingredients) {
    ...
    public void registerRecipesHandling(@Nonnull IModRegistry registry) {
        ...
        List<ComposterRecipeWrapper> recipes = Collections.singletonList(
                new ComposterRecipeWrapper(new FluidStack(MFRFluids.sewage, sewagePerOperation), new ItemStack(MFRThings.fertilizerItem))
        );
